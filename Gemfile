...
# Thin Ruby wrapper around ffmpeg for the studio pipeline
...
group :development do
  ...
  # Preview outgoing mail (invitations) in the browser instead of sending it
  gem "letter_opener"
end

group :test do
  # Cucumber acceptance tests (per project workflow) with Capybara
